...
namespace Oef2{
    public class Data{
        ...
        static Data(){
            ...
            organizations.Add(new Organization() { Id = 5, Name = "De blauwe smurfen" });
            ...
            registrations.Add(new Registration() { RegisterId=1, Naam = "Vandromme", Voornaam = "Jhinthy", Leeftijd = 20, Email = "jhinthy.v@gmail.com", SelectedSlot1 = 1, SelectedSlot2 = 1, SelectedSlot3 = 2, SelectedOrganization = 1, ClosingParty = true });
        }
        ...
        public static void AddOrganisation(Organization newUser) {
            newUser.Id = organizations.Count + 1;
            organizations.Add(newUser);
        }
        public static Device GetDevice(int id) {
            return devices.Find(o => o.Id == id);
        }
